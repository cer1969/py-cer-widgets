...
dam.Headers = [grid.Header("Nombre",defval="Nuevo"),
               grid.Header("Edad",grid.VALUE_NUMBER,34),
               grid.Header("Peso",grid.VALUE_FLOAT,75.5),
               grid.Header(u"Profesión\nActual",grid.VALUE_CHOICE,u"Médico",
                   args=u"Ingeniero,Abogado,Agricultor,Médico,Constructor"),
               grid.Header("Contratado",grid.VALUE_BOOL,1)
               ]
